...
import com.corrinedev.tacznpc.procedures.TerroristScavEntityDiesProcedure;
import com.corrinedev.tacznpc.procedures.TerroristPistolTickingProcedure;
...
public class TerroristScavEntity extends PathfinderMob implements RangedAttackMob, GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TerroristScavEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TerroristScavEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_AmmoCount = SynchedEntityData.defineId(TerroristScavEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_Reloading = SynchedEntityData.defineId(TerroristScavEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_Sprinting = SynchedEntityData.defineId(TerroristScavEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_Crouching = SynchedEntityData.defineId(TerroristScavEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public TerroristScavEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TaczNpcModEntities.TERRORIST_SCAV.get(), world);
	}

	public TerroristScavEntity(EntityType<TerroristScavEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "terroristpistol");
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new HurtByTargetGoal(this) {
			...
			public boolean canUse() {
				...
				double y = TerroristScavEntity.this.getY();
				double z = TerroristScavEntity.this.getZ();
				Entity entity = TerroristScavEntity.this;
				Level world = TerroristScavEntity.this.level();
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((TerroristScavEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((TerroristScavEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public boolean hurt(DamageSource source, float amount) {
		TerroristScavHurtProcedure.execute();
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		TerroristScavSpawnProcedure.execute(this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		TerroristPistolTickingProcedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(TaczNpcModEntities.TERRORIST_SCAV.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 10) {
			this.remove(TerroristScavEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
