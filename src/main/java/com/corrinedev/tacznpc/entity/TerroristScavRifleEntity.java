...
import com.corrinedev.tacznpc.procedures.TerroristScavRifleEntityDiesProcedure;
import com.corrinedev.tacznpc.procedures.TerroristRifleTickingProcedure;
import com.corrinedev.tacznpc.procedures.TerroristRifleScavSpawnProcedure;
import com.corrinedev.tacznpc.procedures.TerroristRifleScavHurtProcedure;
...
public class TerroristScavRifleEntity extends PathfinderMob implements RangedAttackMob, GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TerroristScavRifleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TerroristScavRifleEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_AmmoCount = SynchedEntityData.defineId(TerroristScavRifleEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_Reloading = SynchedEntityData.defineId(TerroristScavRifleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_Sprinting = SynchedEntityData.defineId(TerroristScavRifleEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_Crouching = SynchedEntityData.defineId(TerroristScavRifleEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public TerroristScavRifleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TaczNpcModEntities.TERRORIST_SCAV_RIFLE.get(), world);
	}

	public TerroristScavRifleEntity(EntityType<TerroristScavRifleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "terroristnoarmor");
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new HurtByTargetGoal(this) {
			...
			public boolean canUse() {
				...
				double y = TerroristScavRifleEntity.this.getY();
				double z = TerroristScavRifleEntity.this.getZ();
				Entity entity = TerroristScavRifleEntity.this;
				Level world = TerroristScavRifleEntity.this.level();
		...
		this.goalSelector.addGoal(7, new AvoidEntityGoal<>(this, Player.class, (float) 12, 1, 1));
		this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, Monster.class, (float) 6, 1, 1));
		this.goalSelector.addGoal(9, new WaterAvoidingRandomStrollGoal(this, 0.8));
		this.goalSelector.addGoal(10, new LookAtPlayerGoal(this, Monster.class, (float) 24));
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((TerroristScavRifleEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((TerroristScavRifleEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public boolean hurt(DamageSource source, float amount) {
		TerroristRifleScavHurtProcedure.execute();
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		TerroristRifleScavSpawnProcedure.execute(this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		TerroristRifleTickingProcedure.execute(this);
	...
	public static void init() {
		SpawnPlacements.register(TaczNpcModEntities.TERRORIST_SCAV_RIFLE.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 10) {
			this.remove(TerroristScavRifleEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
